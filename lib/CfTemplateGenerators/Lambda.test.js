...
describe('Lambda', () => {
  ...
  describe('.replacePermissionFunctionWithAlias', () => {
    ...
    it('replaces the permission\'s function for an alias', () => {
      ...
      const expected = fp.set('Properties.FunctionName', permissionFunctionWithAlias, lambdaPermission)
  ...
  describe('.replaceEventMappingFunctionWithAlias', () => {
    ...
    it('replaces the event source mapping\'s function for an alias', () => {
      ...
      const expected = fp.set('Properties.FunctionName', eventMappingFunctionWithAlias, eventSourceMapping)
